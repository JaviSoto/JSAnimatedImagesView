Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/fkuehne/JSAnimatedImagesView.git", :tag => "1.0.1" }
  s.platform     = :ios, '5.0'
  s.platform     = :tvos, '9.0'
  s.source_files = 'JSAnimatedImagesView.{h,m}', 'Dependencies/MSWeakTimer/MSWeakTimer.{h,m}'
  s.requires_arc = true
end
